      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="bg-gray-50 border border-gray-300 text-gray-800 placeholder-gray-500 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-2.5 py-2.5" // Ajustado padding-left e cores
          />
        </div>
      </div>
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            required
            placeholder="••••••••"
            className="bg-gray-50 border border-gray-300 text-gray-800 placeholder-gray-500 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-10 py-2.5" // Ajustado padding-left e padding-right
          />
          <button
            type="button"
